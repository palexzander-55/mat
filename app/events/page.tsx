  ...
  return (
    <main >
      ...
      <div className="container is-fluid" >
        <h1 className="title is-3 pt-3" id={styles.title} style={{ }}>Events, Camps, Performances, and more!</h1>


        <div className="columns is-vcentered">
          <div className="column is-half has-text-centered">
            <iframe className={styles.eventIframe} style={{ maxWidth: '1000px', width: '100%', height: '650px', alignContent: 'center', backgroundColor: 'black', }} loading="lazy" allowFullScreen src="https://app.jackrabbitclass.com/eventcalendar.asp?orgid=551569"></iframe>
          </div>
          <div className="column is-half ">
            <h1 className="subtitle is-3" style={{ }}>Upcoming Events</h1>
            <ul>
              <li>
                <div className="box m-3" >
                  <h1 className="title is-3 has-text-primary" >Spring Performance</h1>
              ...
              <li>
                <div className="box m-3" >
                  <h1 className="title is-3 has-text-primary" >Summer Camp</h1>
        ...
        <h1 className="subtitle is-3 has-text-centered" >Past Events</h1>
        <ul>
          <li>
            <div className="box m-3 " >
              <div className="columns is-vcentered">
                <div className="column ">
                  <h1 className="title is-3  has-text-primary" >Winter Performance 2023</h1>
